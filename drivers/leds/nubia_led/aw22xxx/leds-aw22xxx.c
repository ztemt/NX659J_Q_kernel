...
#define AW22_LOG(fmt, args...) printk(KERN_DEBUG "[aw22xx] [%s: %d] "fmt,  __func__, __LINE__, ##args)
...
void aw22xxx_build_leds_name(void)
{
	...
	{
		if(i == 0){
			strcpy(buf, "aw22xxx_cfg_0.bin");
		}else if(i>=0x50 && i<=0x58){
			sprintf(buf, "aw22xxx_cfg_5%d.bin", i-0x50);
		}else if(i>=0x60 && i<=0x68){
			sprintf(buf, "aw22xxx_cfg_6%d.bin", i-0x60);
		}else if(i>=0x70 && i<=0x78){
			sprintf(buf, "aw22xxx_cfg_7%d.bin", i-0x70);
		}else if(i>=0x80 && i<=0x88){
			sprintf(buf, "aw22xxx_cfg_8%d.bin", i-0x80);
		}else if(i>=0xa0 && i<=0xa8){
			sprintf(buf, "aw22xxx_cfg_a%d.bin", i-0xa0);
		}else{
			strcpy(buf, "null");
		}
