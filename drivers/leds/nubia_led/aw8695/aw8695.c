...
static int aw8695_rtp_update(struct aw8695 *aw8695)
{
	...
	return request_firmware_nowait(THIS_MODULE, FW_ACTION_HOTPLUG,
			aw8695_rtp_name[aw8695->rtp_file_num],aw8695->dev, GFP_KERNEL, aw8695,aw8695_rtp_loaded);
}
...
static int aw8695_rtp_osc_calibration(struct aw8695 *aw8695)
{
	...
	static void aw8695_haptic_audio_work_routine(struct work_struct *work)
	{
		...
		if (aw8695->haptic_audio.ctr.cmd == AW8695_HAPTIC_CMD_ENABLE) {
			if(aw8695->haptic_audio.ctr.play == AW8695_HAPTIC_PLAY_ENABLE) {
				pr_info("%s: haptic_audio_play_start calculate parameter\n", __func__);
				...
				if (((aw8695->touch_audio_gap >= aw8695->gap_min) && (aw8695->touch >= 1) && (aw8695->touch_enable == AW8695_HAPTIC_TOUCH_ENABLE))
						|| ((aw8695->touch_audio_gap <= aw8695->gap_max) && (aw8695->touch < 1) && (aw8695->touch_enable == AW8695_HAPTIC_TOUCH_ENABLE))
						||(aw8695->touch_enable == AW8695_HAPTIC_TOUCH_DISABLE))
				{
					...
					aw8695_haptic_set_wav_seq(aw8695, 0x00,aw8695->haptic_audio.ctr.wavseq);
					aw8695_haptic_set_wav_seq(aw8695, 0x01, 0x00);
					//modify huazhonghua zhixuzhendong
					if (aw8695->haptic_audio.ctr.loop == 15 )
					{
						aw8695->haptic_audio.ctr.loop = 14;
					}
					//end modify huazhonghua zhixuzhendong
					aw8695_haptic_set_wav_loop(aw8695, 0x00,aw8695->haptic_audio.ctr.loop);

					aw8695_haptic_set_gain(aw8695,aw8695->haptic_audio.ctr.gain);
...
static int aw8695_haptic_cont(struct aw8695 *aw8695)
{
	...
	aw8695_i2c_write_bits(aw8695, AW8695_REG_BEMF_NUM,AW8695_BIT_BEMF_NUM_BRK_MASK,aw8695->info.cont_num_brk);
	/* 35*171us=5.985ms */
...
static int aw8695_haptic_f0_calibration(struct aw8695 *aw8695)
{
	...
	aw8695_haptic_play_mode(aw8695, AW8695_HAPTIC_STANDBY_MODE);
	aw8695->play_mode = AW8695_HAPTIC_RAM_MODE;
	aw8695_i2c_write_bits(aw8695, AW8695_REG_SYSCTRL, AW8695_BIT_SYSCTRL_PLAY_MODE_MASK,AW8695_BIT_SYSCTRL_PLAY_MODE_RAM);
	aw8695_haptic_stop(aw8695);
...
static int aw8695_haptic_init(struct aw8695 *aw8695)
{
	...
	aw8695->gap_min = 10000;
	aw8695->gap_max = 500000;
	...
	aw8695_i2c_write_bits(aw8695, AW8695_REG_ANADBG,AW8695_BIT_ANADBG_IOC_MASK, AW8695_BIT_ANADBG_IOC_4P65A);
	...
	/* vbat compensation */
	aw8695_haptic_cont_vbat_mode(aw8695,AW8695_HAPTIC_CONT_VBAT_HW_COMP_MODE);
...
static ssize_t aw8695_gap_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	...
	/* For now nothing to show */
	return snprintf(buf, PAGE_SIZE, "gap_min: %d, gap_max: %d\n", aw8695->gap_min, aw8695->gap_max);
}

static ssize_t aw8695_gap_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	...
	if(2 == sscanf(buf, "%x %x", &databuf[0], &databuf[1])) {
			...
			mutex_lock(&aw8695->lock);
			aw8695->gap_min = databuf[0];
			aw8695->gap_max = databuf[1];
			mutex_unlock(&aw8695->lock);
	}
...
static ssize_t aw8695_reg_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_reg_store(struct device *dev,struct device_attribute *attr, const char *buf,
				size_t count)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static ssize_t aw8695_rtp_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_rtp_store(struct device *dev,struct device_attribute *attr, const char *buf,
				size_t count)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static ssize_t aw8695_ram_update_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	/* struct timed_output_dev *to_dev = dev_get_drvdata(dev); */
	/*struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);*/
...
static ssize_t aw8695_f0_store(struct device *dev,struct device_attribute *attr, const char *buf,
			       size_t count)
{
#ifdef TIMED_OUTPUT
	/* struct timed_output_dev *to_dev = dev_get_drvdata(dev); */
...
static ssize_t aw8695_cali_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_cali_store(struct device *dev,struct device_attribute *attr, const char *buf,
				 size_t count)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static ssize_t aw8695_cont_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_cont_store(struct device *dev,struct device_attribute *attr, const char *buf,
				 size_t count)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static ssize_t aw8695_cont_zc_thr_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_auto_boost_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_prctmode_show(struct device *dev, struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static ssize_t aw8695_trig_show(struct device *dev,struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
	struct aw8695 *aw8695 = container_of(to_dev, struct aw8695, to_dev);
...
static DEVICE_ATTR(gap, S_IWUSR | S_IRUGO, aw8695_gap_show, aw8695_gap_store);
...
static int aw8695_read_chipid(struct aw8695 *aw8695)
{
	...
	while (cnt < AW_READ_CHIPID_RETRIES) {
		...
		usleep_range(AW_READ_CHIPID_RETRY_DELAY * 1000,AW_READ_CHIPID_RETRY_DELAY * 1000 + 500);
	}
...
static ssize_t aw8695_i2c_reg_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	struct aw8695 *aw8695 = dev_get_drvdata(dev);
	ssize_t len = 0;
	unsigned char i = 0;
...
static ssize_t aw8695_i2c_ram_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	struct aw8695 *aw8695 = dev_get_drvdata(dev);
	ssize_t len = 0;
	unsigned int i = 0;
